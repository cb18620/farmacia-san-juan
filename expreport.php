        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Gestión de informes de medicamentos por fecha de caducidad</h3> </div>
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                   <form class="form-horizontal" action="getproductreport.php" method="post" id="getOrderReportForm">
                                        ...
                                        <button type="submit"  id="generateReportBtn" class="btn btn-primary btn-flat m-b-30 m-t-30">Generar</button>
                                    </form>
                                </div>
                            </div>
                        </div>
