        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Gestion de Ventas</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                        <li class="breadcrumb-item active">Ventast</li>
                    </ol>
                </div>
            </div>
                                    ...
                                    <form class="form-horizontal" method="POST"  id="createOrderForm" action="php_action/order.php" action="php_action/order.php">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                              ...
                                              <label class="col-sm-2 control-label">Venta N°</label>
                                               <div class="col-sm-4">
                                                <?php 
...
$n="VENTA N°-000";
   $l=$res['id']+1;
   $stall_no= $n."".$l; ?>
                                                <input type="text" class="form-control" placeholder="Venta Numero" value="<?php echo $stall_no; ?>" autocomplete="off" name="uno" required/>
                                               </div>


                                                <label class="col-sm-2 control-label">Fecha Venta</label>
  ...
  <?php
    ...
    $productSql = "SELECT product_id, product_name, expdate FROM product WHERE active = 1 AND status = 1 AND quantity != 0";
    $productData = $connect->query($productSql);

    while($row = $productData->fetch_array()) {                     
      echo "<option value='".$row['product_id']."' id='changeProduct".$row['product_id']."'>".$row['product_name']." - Expira: ".$row['expdate']."</option>";
    } // /while 
  ?>
</select>
                  </div>
...
<td >
            ...
            ?>
              ...
              <input type="hidden" class="form-control" id="subTotalValue" name="subTotalValue" />
                                                ...
                                                <label for="totalAmount" class="col-sm-2 control-label">Cantidad Total</label>
                                                  <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label for="vat" class="col-sm-2 control-label gst">impuestos 13%</label>
                                                <div class="col-sm-4">
            ...
            <div class="col-sm-4">
              <select class="form-control" name="paymentType" id="paymentType">
                ...
                <option value="5">TRANSFERENCIA</option> 
                                            ...
                                            <div class="form-group">
                                            <div class="row">
                                               <label for="clientContact" class="col-sm-2 control-label">Estado de Pago</label>
            <div class="col-sm-4">
        ...
        <div class="form-group submitButtonFooter">
          <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" id="createOrderBtn" data-loading-text="Loading..." class="btn btn-success btn-flat m-b-30 m-t-30"><i class="glyphicon glyphicon-ok-sign"></i> Vender</button>

            <button type="reset" class="btn btn-danger btn-flat m-b-30 m-t-30" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i> Borrar</button>
          </div>
        </div>
...
// SELCCIONAR UN PRODUCTO CON EL BUSCADOR
function getProductData(row = null) {
    if(row) {
      var productId = $("#productName"+row).val();   
        ...
        alert('¡No hay fila! Por favor, actualiza la página y vuelve a intentarlo.');
    }
...
function paymentOrder(orderId = null) {
  if(orderId) {
    ...
    $.ajax({
      ...
      success:function(response) {        
        ...
        $("#updatePaymentOrderBtn").unbind('click').bind('click', function() {
          ...
          if(payAmount == "") {
            $("#payAmount").after('<p class="text-danger">El campo Importe del pago es obligatorio</p>');
          ...
          if(paymentType == "") {
            $("#paymentType").after('<p class="text-danger">El campo Importe del pago es obligatorio</p>');
            $("#paymentType").closest('.form-group').addClass('has-error');
          } else {
            $("#paymentType").closest('.form-group').addClass('has-success');
          }
          ...
          if(paymentStatus == "") {
            $("#paymentStatus").after('<p class="text-danger">El campo Importe del pago es obligatorio</p>');
            $("#paymentStatus").closest('.form-group').addClass('has-error');
          } else {
            $("#paymentStatus").closest('.form-group').addClass('has-success');
          }
    ...
    alert('Error ! Actualizar la página de nuevo');
  }
}
$(document).ready(function() {
        $('[id^=productName]').select2({
            placeholder: "Buscar y seleccionara un producto",
            allowClear: true
        });
    });
</script>
