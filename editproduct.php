 ...
 <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Editar Medicamento</h3> </div>
...
<div class="changeUsenrameMessages"></div>
                                    ...
                                    <div class="form-group">
                                      <div class="row">
                                        ...
                                        <button type="submit"  name="btn" id="changeUsernameBtn" class="btn btn-primary btn-flat m-b-30 m-t-30">Guardar Cambios</button></div>
                                        </fieldset> -->
 .
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                                ...
                                                <label class="control-label">Precio Compra</label>
                                                   <input type="text" class="form-control" id="rate_compra" value="<?php echo $result['rate_compra']?>" name="rate_compra" autocomplete="off">
                                        </div>
                                        <!-- <div class="form-group col-md-6">
...
?></select>
                        ...
                        <option value="1" <?php 
                                                        ...
                                                        ?>>Disponible</option>
                                                        <option value="2" <?php if($result['active']=="2"){ echo "selected";}?>>No Disponible</option>
                      </select>
                                        </div>
