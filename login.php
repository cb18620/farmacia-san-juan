...
if($_POST) {    
  ...
  <div class="popup__content">
    ...
    <p>Contraseña/Email Incorrectos</p>
    <p>
...
?>
    ...
    <div id="main-wrapper">
        <div class="unix-login">
            ...
            <div class="container-fluid" style="background-image: url('assets/uploadImage/Logo/farmaci.png');
 background-color: #ffffff;background-size:cover">
                <div class="row ">
                    <div class="col-md-4">
                        <div class="login-content ">
                            <div class="login-form">
                                <center><img src="./assets/uploadImage/Logo/farmacia.png" style="width: 500px;"></center><br> 
    ...
    <input type="text" name="email" id="email" class="form-control" placeholder="email" required="">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-md-6 form-check">
                                            ...
                                            <label class="form-check-label" for="exampleCheck1">Acuerdate demi</label>
                                        </div>
                                        <div class="forgot-phone col-md-6 text-right">
                                            <a href="#" class="text-right f-w-600 text-gray"> Has olvidado tu contraseña?</a>
                                        </div>
                                 
                                   <div class="col-md-12"> 
                                       <button style="background-color: #102b49; border-radius: 50px;" type="submit" name="login" class=" f-w-600 text-white btn  btn-flat m-b-30 m-t-30">Iniciar Session</button>
                                   </div>
                                </form>
                            </div>
                        </div>
