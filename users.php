    ...
    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="php_action/removeUser.php?id=<?php echo $row['user_id']?>" ><button type="button" class="btn btn-xs btn-danger" onclick="return confirm('¿Estás segura de eliminar este registro?')"><i class="fa fa-trash"></i></button></a>
