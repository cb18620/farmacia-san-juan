        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Gestión de informes por fecha</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Inico</a></li>
                        <li class="breadcrumb-item active">>Informe por fecha</li>
                    </ol>
                </div>
            </div>
