       ...
       <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Ver Categorias</h3> </div>
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            ...
                            <a href="add-category.php"><button class="btn btn-primary">Agregar Categorias</button></a>
    ...
    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="php_action/removeCategories.php?id=<?php echo $row['categories_id']?>" ><button type="button" class="btn btn-xs btn-danger" onclick="return confirm('¿Estás segura de eliminar este registro?')"><i class="fa fa-trash"></i></button></a>
