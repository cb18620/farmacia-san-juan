       ...
       <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Ver Proveedor</h3> </div>
    ...
    ?>
                                        <tr>
                                            ...
                                            <td><?php  if($row['brand_active']==1)
                                            {
                                                ...
                                                $activeBrands = "<label class='label label-danger'><h4>Not Disponible</h4></label>";
                                                echo $activeBrands;
                                            }?></td>
                                            <td>
                                                ...
                                                <a href="php_action/removeBrand.php?id=<?php echo $row['brand_id']?>" ><button type="button" class="btn btn-xs btn-danger" onclick="return confirm('¿Estás segura de eliminar este registro?')"><i class="fa fa-trash"></i></button></a>
